...
//         "Fixed-Route Passenger Trips 2019 - 2026" chart (September 2026 packet, PDF p.34).
...
// 2026 is a partial year (Jan-August) at the time of the September 2026 packet.
const MONTHLY = {
  ...
  2026: [268640, 277303, 307953, 315938, 322056, 319644, 287348, 304748],
};
...
const PRINTED_TOTALS = {
  ...
  2023: 3225819, 2024: 3385717, 2025: 3512037, 2026: 2403630,
};
...
const data = {
  ...
  source: {
    name: "Metro September 2026 Board Packet",
    url: "https://www.ometro.com/september-2026-board-packet/",
